...
matar ok váða                   there is need of food and clothes
...
# skyli manna hverr        moderately wise,
# æva til snotr sé        but never too wise:
# því at snotrs manns hjarta        because the wise man's heart
...
# 
# "Snapir ok gnapir        The eagle snatches and stretches
...
# eða tvau lær hengi        or two hams would hang
...
# at þessu trúi öllu        that he trusts all these."
# 
# "Svá er friðr kvenna         The love of women
...
# sá er fátt kann segja         the one who knows how to say almost nothing:
# þat er ósnotrs aðal        it is the character of the unwise."
# 
# "Inn aldna jötum ek sótta         I sought the old giant,
...
# 
# "Rata munn         I let the mouth of the gimlet
...
# sá ek ok þagðak         I saw and stayed silent,
...
# né um ráðum þögþu        nor were they silent in counsels
...
# því at hrísi vex        for the path which no-one treads
...
# þá er inn verri vegr        when the worser attacks."
# 
# "Ráðumk þér Loddfáfnir         I advise you, Loddfafnir,
# en þú ráð nemir         to take advice:
# njóta mundu ef þú nemr         you would benefit, it you took it,
...
# skór er skapaðr illa        if the shoe is badly made
...
# verða gumna synir        like men terror-crazed --
...
# ok við annars konu        and with another's woman,
...
# opt ór skörpum belg        often clear words come
...
# ok váfir með vílmögum        and moves among the entrails."
# 
# "Ráðumk þér Loddfáfnir         I advise you, Loddfafnir,
# en þú ráð nemir         to take advice:
# njóta mundu ef þú nemr         you would benefit, it you took it,
...
# en eldr við sóttum         and fire against sickness,
...
# heiptum skal mána kveðja        -- one must invoke the moon against wrathful deeds --
...
# 
# "Fimbulljóð níu        I took nine mighty spells
...
# er mik armi verr        who is wrapped in my arm
# eða mín systir sé [#]        or is my sister."
# 
# "Nú era Háva mál         Now the sayings of Har are spoken
# kveðin Háva höllu í        in Har's hall,
# allþörf ýta sonum        very needful to the sons of men,
# óþörf jötna sonum        harmful to the sons of giants.
...
# heilir þeirs hlýddu        Blessings on those who listened!"

)

NUM_ELEMENTS=${#STANZAS[@]}
RANDOM_INDEX=$((RANDOM % NUM_ELEMENTS))
RANDOM_VALUE=${STANZAS[$RANDOM_INDEX]}
